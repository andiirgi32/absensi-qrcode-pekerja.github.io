      ...
      <li class="nav-item">
        ...
        <div id="collapseTableAbsensiPelajar" class="collapse show" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="card py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active btn-light" style="border: 0px;" href="absensi_harian.php">
              Absensi Harian
            </a>
      ...
      <div id="content">
        ...
        <div class="container-fluid bg-body-tertiary" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0">Absensi Harian Pekerja</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Absensi Harian Pekerja</li>
            </ol>
          </div>

          <div class="container bg-body-tertiary py-3 mb-5" id="absensi_harian">
            <form action="#absensi_harian" method="GET">
              <div class="input-group mb-3">
                ...
                <select class="form-select" name="filter_jabatan">
                  ...
                  ?>
                      <option value="<?= $data_jabatan['jabatan'] ?>" <?php echo isset($_GET['filter_jabatan']) && $_GET['filter_jabatan'] == $data_jabatan['jabatan'] ? 'selected' : ''; ?>><?= $data_jabatan['jabatan'] ?></option>
                    <?php
                    }
            ...
            <div class="row">
              ...
              $sql = "SELECT pekerja.*, pangkat.*, absen.*, jabatan.*, golongan.* FROM pekerja INNER JOIN absen ON pekerja.nip = absen.nip INNER JOIN pangkat ON pekerja.pangkatid = pangkat.pangkatid INNER JOIN jabatan ON pekerja.jabatanid = jabatan.jabatanid INNER JOIN golongan ON pekerja.golonganid = golongan.golonganid WHERE 1";

              if (!empty($filter_date)) {
                $sql .= " AND absen.tanggal = '$filter_date'";
              } elseif ($_SESSION['role'] == "Wali Kelas") {
                $jabatanid = $_SESSION['jabatanid'];
                if (isset($_GET['filter_jabatan'])) {
                  $jabatan = $_GET['filter_jabatan'];
                  $sql .= " AND jabatan.jabatan = '$jabatan'";
                } else {
                  $tanggal = date("Y-m-d");
                  $sql .= " AND jabatan.jabatanid = '$jabatanid' AND absen.tanggal = '$tanggal'";
                }
              } elseif (empty($filter_jabatan)) {
                $tanggal = date("Y-m-d");
                        ...
                        <div class="col-md-8">
                          <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                              ...
                              <li class="list-group-item">Pangkat/Golongan: <?= $data['pangkat'] ?>/<?= $data['golongan'] ?></li>
                              ...
                              <li class="list-group-item">
                                ...
                                ?>
                                  ...
                                  (
                                  <?php
                                  if ($data["keterangandatang"] == "Tepat Waktu") {
                                  ?>
                                    <b class="text-success"><?= $data['keterangandatang'] ?></b>
                                  <?php
                                  } elseif ($data["keterangandatang"] == "Terlambat") {
                                  ?>
                                    <b class="text-danger"><?= $data['keterangandatang'] ?></b>
                                  <?php
                                  } elseif ($data["keterangandatang"] == "Absen Cepat") {
                                  ?>
