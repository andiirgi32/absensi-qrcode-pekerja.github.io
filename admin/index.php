      ...
      <div id="content">
        ...
        <div class="container-fluid bg-body-tertiary" id="container-wrapper">
          ...
          <div class="container-fluid">
            ...
            if ($waktuHariIni >= '00:00:00' && $waktuHariIni <= '05:29:59') {
            ?>
              <div class="row justify-content-center">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="alert alert-info alert-dismissible text-gray-700" role="alert">
                    ...
                    <h6><i class="fas fa-info"></i><b> Information Kepada Yth. <?= $_SESSION['namalengkap'] ?></b></h6>
                    Absensi Datang Segera Dibuka Pada Jam 05.30 WITA, harap jangan telat ya!
                  </div>
                </div>

              </div>
            <?php
            } else if ($waktuDatang != "00:00:00" && $waktuHariIni >= '05:30:00' && $waktuHariIni <= '08:09:59') {
            ?>
              <div class="row justify-content-center">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="alert alert-success alert-dismissible text-gray-700" role="alert">
                    ...
                    <h6><i class="fas fa-check"></i><b> Yth. <?= $_SESSION['namalengkap'] ?>. Anda Sudah Absensi Datang Hari Ini!</b></h6>
                    Silahkan Lakukan Absensi Pulang Pada Jam 14.00 WITA!
                  </div>
                </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="alert alert-warning alert-dismissible text-gray-700" role="alert">
                    ...
                    <h6><i class="fas fa-exclamation-triangle"></i><b> Yth. <?= $_SESSION['namalengkap'] ?>. Anda Belum Melakukan Absensi Hari Ini!</b></h6>
            ...
            <?php
            } else if ($waktuHariIni >= '08:10:00' && $waktuHariIni <= '13:59:59') {
            ?>
              <div class="row justify-content-center">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="alert alert-info alert-dismissible text-gray-700" role="alert">
                    ...
                    <h6><i class="fas fa-info"></i><b> Information Kepada Yth. <?= $_SESSION['namalengkap'] ?></b></h6>
                    Absensi Datang Sudah Selesai. Absensi Pulang Segera Dibuka Pada Jam 14.00 WITA, harap jangan telat ya!
                  </div>
                </div>

              </div>
            <?php
            } else if ($waktuPulang == "00:00:00" && $waktuHariIni >= '14:00:00' && $waktuHariIni <= '17:30:00') {
            ?>
              <div class="row justify-content-center">
            ...
            <?php
            } else if ($waktuPulang != "00:00:00" && $waktuHariIni >= '14:00:00' && $waktuHariIni <= '18:00:00') {
            ?>
              <div class="row justify-content-center">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="alert alert-success alert-dismissible text-gray-700" role="alert">
                    ...
                    <h6><i class="fas fa-check"></i><b> Yth. <?= $_SESSION['namalengkap'] ?>. Anda Sudah Absensi Pulang Hari Ini!</b></h6>
                    Silahkan Pulang Dan Datang Pada Besok Hari Untuk Melakukan Absensi Datang Pada Jam 05.30 WITA!
                  </div>
                </div>
                    ...
                    <div class="card h-100">
                      <div class="card-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-auto">
                            <i class="bi bi-bar-chart-line-fill fa-3x" style="color: darkolivegreen;"></i>
                          </div>
                        </div>
                      </div>
                    </div>
