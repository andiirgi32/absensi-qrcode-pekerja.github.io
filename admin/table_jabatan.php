...
<body id="page-top">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          ?>
                            <td>
                              <a href="" data-bs-toggle="modal" data-bs-target="#editJabatan<?= $data['jabatanid'] ?>" class="btn btn-warning mb-1"><i class="bi bi-pencil-square"></i></a>
                              <form action="hapus_jabatan.php?jabatanid=<?= $data['jabatanid'] ?>" method="post" onsubmit="return confirm('Apakah kamu yakin ingin menghapusnya?')" style="display: inline;">
  ...
  <?php
  $kelasArray = [
    "KEPALA SEKOLAH", "GURU", "KEPALA TATA USAHA", "STAF", "GTT", "PTT",
  ];
