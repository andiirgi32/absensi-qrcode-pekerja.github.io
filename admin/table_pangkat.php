...
<head>
  ...
  <title>Ruang<?= $_SESSION['role'] ?> - Table Pangkat</title>
...
<body id="page-top">
        ...
        <li class="nav-item">
          ...
          <div id="collapseTable" class="collapse show" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="card py-2 collapse-inner rounded">
              ...
              <a class="collapse-item active btn-light" href="table_pangkat.php">Table Pangkat</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid bg-body-tertiary" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0">DataTable Pangkat</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item" aria-current="page">Tables</li>
              <li class="breadcrumb-item active" aria-current="page">DataTable Pangkat</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Table Pangkat</h6>
                  <?php
                  if ($_SESSION['role'] == "Admin") {
                  ?>
                    <a href="" data-bs-toggle="modal" data-bs-target="#tambahPangkat" class="btn btn-primary btn-sm"><i class="bi bi-file-earmark-plus-fill"></i></a>
                  <?php
                  }
                  ?>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-striped table-hover" id="dataTable">
                    ...
                    <tbody>
                      <?php
                      $sql = mysqli_query($conn, "SELECT * FROM pangkat");
                      $no = 1;
                      while ($data = mysqli_fetch_array($sql)) {
                        if ($data['pangkat'] == "Tidak Memiliki") {
                      ...
                      ?>
                        <tr>
                          ...
                          ?>
                            <td>
                              <a href="" data-bs-toggle="modal" data-bs-target="#editPangkat<?= $data['pangkatid'] ?>" class="btn btn-warning mb-1"><i class="bi bi-pencil-square"></i></a>
                              <form action="hapus_pangkat.php?pangkatid=<?= $data['pangkatid'] ?>" method="post" onsubmit="return confirm('Apakah kamu yakin ingin menghapusnya?')" style="display: inline;">
  ...
  <!-- Modal Scrollable -->
  <div class="modal fade" id="tambahPangkat" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
      <form class="modal-content" action="proses_pangkat.php" method="post">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalScrollableTitle">Tambah Pangkat</h5>
          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          ...
          <select name="pangkat" id="pangkat" class="form-control mb-2" required>
            <option value="">Pilihan</option>
          ...
          <input type="text" id="pangkat_other" class="form-control mb-2" placeholder="Masukkan kelas lainnya" style="display: none;" required>

          <script>
            document.addEventListener('DOMContentLoaded', () => {
              const selectElement = document.getElementById('pangkat');
              const inputOther = document.getElementById('pangkat_other');
  ...
  <?php
  $kelasArray = [
    "Pembina Tk.I", "Pembina", "Penata Tk.I", "Penata Muda Tk.I", "Penata Muda", "Ahli Pertama", "Tidak Memiliki",
  ];
  ...
  ?>
    <!-- Modal Scrollable -->
    <div class="modal fade" id="editPangkat<?= $data['pangkatid'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <form class="modal-content" action="update_pangkat.php" method="post">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalScrollableTitle">Edit Pangkat</h5>
            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <input type="text" name="pangkatid" value="<?= $data['pangkatid'] ?>" hidden required>
            <label for="pangkatEdit<?= $index ?>">Pangkat</label>
            <select name="pangkat" id="pangkatEdit<?= $index ?>" class="form-control mb-2" required>
              <?php
              // Jika $data['pangkat'] tidak ada di $kelasArray, tambahkan sebagai opsi
              if (!in_array($data['pangkat'], $kelasArray)) : ?>
                <option value="<?= $data['pangkat'] ?>" selected><?= $data['pangkat'] ?></option>
              <?php endif; ?>
              <option value="Pembina Tk.I" <?= $data['pangkat'] == "Pembina Tk.I" ? "selected" : "" ?>>Pembina Tk.I</option>
              <option value="Pembina" <?= $data['pangkat'] == "Pembina" ? "selected" : "" ?>>Pembina</option>
              <option value="Penata Tk.I" <?= $data['pangkat'] == "Penata Tk.I" ? "selected" : "" ?>>Penata Tk.I</option>
              <option value="Penata Muda Tk.I" <?= $data['pangkat'] == "Penata Muda Tk.I" ? "selected" : "" ?>>Penata Muda Tk.I</option>
              <option value="Penata Muda" <?= $data['pangkat'] == "Penata Muda" ? "selected" : "" ?>>Penata Muda</option>
              <option value="Ahli Pertama" <?= $data['pangkat'] == "Ahli Pertama" ? "selected" : "" ?>>Ahli Pertama</option>
              <option value="Tidak Memiliki" <?= $data['pangkat'] == "Tidak Memiliki" ? "selected" : "" ?>>Tidak Memiliki</option>
              <option value="other">Lainnya</option> <!-- Opsi untuk menampilkan input teks -->
            </select>
            <input type="text" id="pangkatEdit_other<?= $index ?>" class="form-control mb-2" placeholder="Masukkan kelas lainnya" value="<?= $data['pangkat'] ?>" style="display: none;" required>
            <script>
              document.addEventListener('DOMContentLoaded', () => {
                const selectElementEdit = document.getElementById('pangkatEdit<?= $index ?>');
                const inputOtherEdit = document.getElementById('pangkatEdit_other<?= $index ?>');
