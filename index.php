          ...
          <tbody>
            <?php while ($key = mysqli_fetch_assoc($result_sql)) : ?>
              ...
              <tr>
                ...
                <td width="100px"><?= $key["nip"]; ?></td>
                <td width="100px"><?= $key["jabatan"]; ?></td>
                <td width="225px"><?= $key["pangkat"]; ?>/<?= $key["golongan"]; ?></td>
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item">NIP: <?= $semua_hari_ini['nip'] ?></li>
                    <li class="list-group-item">Jabatan: <?= $semua_hari_ini['jabatan'] ?></li>
                    <li class="list-group-item">Pangkat/Golongan: <?= $semua_hari_ini['pangkat'] ?>/<?= $semua_hari_ini['golongan'] ?></li>
